...
I used all of the 4 OOP principles (inheritance, abstraction, polymorphism, encapsulation) and also some design patterns (builder and singleton) and created a custom error hierarchy.. The project is involved in a Continuous Integration system, created by an analyst, to compile and check our code on different machines. I've also made some tests for the CI system to run over 80% of the code to check for memory errors.
