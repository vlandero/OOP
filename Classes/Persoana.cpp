...
void Persoana::calculeazaPret(Bilet &b, std::istream &in, std::ostream &out) {
    ...
    int b1 = 0, b2 = 0;
    out << "Introduceti numarul de bagaje de cala dorit (" << pretBagajCala
        << " per bagaj, pe langa cele incluse daca exista)\n";
    in >> b1;
    out << "Introduceti numarul de bagaje de mana dorit (" << pretBagajMana
        << " per bagaj, pe langa cele incluse daca exista)\n";
    in >> b2;
    b.setBagajeMana(b2);
    b.setBagajeCala(b1);
